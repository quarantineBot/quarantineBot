...
- **Cross Court** 🆕 — an everything-tennis hub: live ATP/WTA scores, rankings, players & tournaments proxied from **ESPN**, a head-to-head comparator, news, and podcasts. `Next.js 15 (App Router) · Tailwind v4`.
...
- Building **Cross Court** — a live-data tennis hub (`Next.js 15`, ESPN-powered scores & rankings).
